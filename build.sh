...
build_binutils() {
    ...
    ../configure \
        CFLAGS="-flto -flto-compression-level=10 -O2 -pipe -ffunction-sections -fdata-sections" \
        CXXFLAGS="-flto -flto-compression-level=10 -O2 -pipe -ffunction-sections -fdata-sections" \
        --prefix="${target_dir}" \
        --target=${target} \
        --disable-werror \
        --enable-lto \
